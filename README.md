**pqax** aims to make it easier to start optimzing post-quantum crypto using ARM NEON. Currently, it is only tested on the the Raspberry Pi 4 (which has a ARM Cortex-A72).
